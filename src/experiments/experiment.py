...
dt_train, dt_test, train_y, test_y, train_cases, test_cases, vocab_size, max_prefix_length = dataset_manager.create_data(cat_cols = attack_cols, train_ratio=train_ratio, prefix_generation=False)
